---
name: implement-task
description: /plan-task로 선정된 이슈를 구현하고, 빌드·Playwright 테스트 후 커밋·이슈 업데이트·PR 생성까지 완료한다. 반드시 /plan-task 실행 후에 호출한다.
---
...
- CLAUDE.md §4 디렉토리 컨벤션을 따른다 (kebab-case 파일명, PascalCase 컴포넌트명)
